...
try:
    # 直接執行 `python scripts/ingest_cwv_crux_history.py` 時 sys.path[0] 是
    # 本檔所在目錄（scripts/），flat import 會先成功。
    import ingestion_run_retry as _run_retry
except ImportError:
    # pytest 以 `from scripts import ingest_cwv_crux_history` 套件路徑匯入時，
